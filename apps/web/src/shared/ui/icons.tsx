...
export function IconClock({ size = 12 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconUser({ size = 14 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconFileText({ size = 22 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconMoreHorizontal({ size = 18 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
