...
- **feedback 메모리** (반복 실수·교정): `/Users/bae/.claude/projects/-Users-bae-Eobom-fullstack/memory/feedback_<주제>.md`
- **project 메모리** (발견된 설계 결함·이슈): `/Users/bae/.claude/projects/-Users-bae-Eobom-fullstack/memory/project_<기능>.md`
